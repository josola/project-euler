...
int main()
{
    ...
    for (int i = 0; i < 988; i++)
    {
        ...
        // Current product from large_num.
        for (int j = 0; j < 13; j++)
        {
            // Track current equation for nice output.
            current_equation[j] = large_num[j + i];
        ...
        {
            // Keep tracked equation for highest output.
            for (int i = 0; i < 13; i++)
            {
                highest_equation[i] = current_equation[i];
            }

            // Keep product and position.
    ...
    // ----- Output.
    cout << "Highest product: " << highest_product << endl;
    ...
    for (int i = 0; i < 13; i++)
    {
        if (i == 12)
        {
            cout << highest_equation[i] << endl;
        }
        else
        {
            cout << highest_equation[i] << ", ";
        }
    }

    cout << "At position: " << highest_position << endl;
    // -----
